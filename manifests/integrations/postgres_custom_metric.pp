...
#   consisting of two columns -- the stackstate metric name and the metric type.
#
# $relation:
#   ?
#
...
#   fields -- column name, and stackstate tag.
define stackstate_agent::integrations::postgres_custom_metric(
  $query,
  $metrics,
  $relation = false,
  $descriptors = [],
